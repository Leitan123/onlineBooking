        ...
        {addedPhotos.map((link, index) => (
          <div key={index} className="relative h-32 flex">
            ...
            <button
              ...
              className="absolute bottom-0 right-0 text-red-600 bg-white rounded bg-opacity-70"
            >
              <svg
            ...
            <button
              ...
              className="absolute bottom-0 text-red-600 bg-white rounded bg-opacity-70"
            >
              {link !== addedPhotos[0] && (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
